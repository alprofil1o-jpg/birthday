    ...
    <Card className="p-6 bg-white dark:bg-gray-800 shadow-lg">
      <div>
        ...
        <button onClick={() => setExpanded(!expanded)}
          className="w-full text-xs text-indigo-500 hover:underline text-center mb-1">
          {expanded ? '▲ Kevesebb' : '▼ Részletes beállítások'}
        </button>

        {expanded && (
          <div className="mt-2 space-y-4 border-t pt-3 border-gray-100 dark:border-gray-700">
            {bSettings.enabled && (
